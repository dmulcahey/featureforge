...
pub(crate) fn regenerate_projection_artifacts_from_authoritative_state(
    ...
    {
        regenerate_release_readiness_projection(runtime, context, &record_id, &record)?;
    ...
    {
        regenerate_final_review_projection(runtime, context, &record_id, &record)?;
    ...
    {
        regenerate_browser_qa_projection(runtime, context, &record_id, &record)?;
...
fn regenerate_final_review_projection(
    ...
    let authoritative_reviewer_path = authoritative_reviewer_path
        ...
        .transpose()?;
    let canonical_reviewer_projection_path = project_artifact_dir(runtime).join(format!(
        "featureforge-{}-independent-review-{}.md",
        runtime.safe_branch,
    ...
    let reviewer_name = canonical_reviewer_projection_path
        .file_name()
...
mod tests {
    ...
    fn regenerate_test_plan_projection_uses_stable_fingerprint_suffix() {
        ...
        let first = regenerate_test_plan_projection(&runtime, &record)
            .expect("test-plan regeneration should succeed")
            .expect("test-plan regeneration should publish a projection path");
        let second = regenerate_test_plan_projection(&runtime, &record)
