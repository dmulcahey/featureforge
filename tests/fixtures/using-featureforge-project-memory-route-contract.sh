...
_MUTATING_PROJECT_MEMORY_PATH="(set up|repair|rewrite|update|edit|fix|add|append|write|create).{0,120}docs/project_notes/(readme|bugs|decisions|key_facts|issues)\\.md"
