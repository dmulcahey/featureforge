...
fn write_plan_design_review_artifact(state: &Path, repo: &Path, plan_path: &str, result: &str) -> PathBuf {
    let slug = discover_slug_identity(repo);
    let plan_fingerprint = sha256_hex(
        fs::read(repo.join(plan_path))
            .expect("plan source should be readable for design review fixture")
            .as_slice(),
    );
    let artifact_path = state.join("projects").join(&slug.repo_slug).join(format!(
        "reviewer-{}-plan-design-review-20260328T010000Z.md",
        slug.safe_branch
    ));
    fs::create_dir_all(
        artifact_path
            .parent()
            .expect("design review artifact parent should exist"),
    )
    .expect("design review artifact directory should exist");
    let body = format!(
        "# Plan Design Review Result\n**Artifact Kind:** plan-design-review\n**Schema Version:** 1\n**Artifact Provenance:** runtime-owned\n**Retention Policy:** featureforge:authoritative-runtime-artifact\n**Source Plan:** `{plan_path}`\n**Source Plan Revision:** 1\n**Source Plan Fingerprint:** {plan_fingerprint}\n**Branch:** {}\n**Repo:** {}\n**Receipt Fingerprint:** __FINGERPRINT__\n**Result:** {result}\n**Generated By:** featureforge:plan-design-review\n**Generated At:** 2026-03-28T01:00:00Z\n\n## Summary\n- design review fixture\n",
        slug.branch_name, slug.repo_slug,
    );
    let fingerprint_source = body
        .lines()
        .filter(|line| !line.trim().starts_with("**Receipt Fingerprint:**"))
        .collect::<Vec<_>>()
        .join("\n");
    let fingerprint = sha256_hex(fingerprint_source.as_bytes());
    let source = body.replace("__FINGERPRINT__", &fingerprint);
    fs::write(&artifact_path, source).expect("plan-design-review artifact should write");
    artifact_path
}
...
#[test]
fn canonical_workflow_status_routes_design_review_required_draft_plan_to_plan_design_review() {
    let (repo_dir, state_dir) = init_repo("workflow-runtime-plan-design-review-required");
    let repo = repo_dir.path();
    let state = state_dir.path();
    let spec_path = "docs/featureforge/specs/2026-01-22-document-review-system-design.md";
    let plan_path = "docs/featureforge/plans/2026-01-22-document-review-system.md";
    ...
    write_file(
        &repo.join(plan_path),
        "# Draft Plan\n\n**Workflow State:** Draft\n**Plan Revision:** 1\n**Execution Mode:** none\n**Source Spec:** `docs/featureforge/specs/2026-01-22-document-review-system-design.md`\n**Source Spec Revision:** 1\n**Last Reviewed By:** writing-plans\n**Contract Version:** 2\n**Delivery Lane:** standard\n\n## Requirement Coverage Matrix\n\n- REQ-001 -> Task 1\n\n## Risk & Gate Signals\n- Delivery Lane: standard\n- UI Scope: material\n- Browser QA Required: no\n- Design Review Required: yes\n- Security Review Required: no\n- Performance Review Required: no\n- Release Surface: code_only_no_deploy\n- Distribution Impact: low\n- Deploy Impact: low\n- Migration Risk: low\n\n## Release & Distribution Notes\n- Discoverability / Distribution Path: internal only\n- Versioning Decision: unknown\n- Versioning Rationale: planning fixture\n- Deployment / Rollout Notes: none\n\n## Task 1: Prepare the draft plan for review\n\n**Spec Coverage:** REQ-001\n**Task Outcome:** The draft plan is ready for design review.\n**Plan Constraints:**\n- Keep the fixture minimal.\n**Open Questions:** none\n\n**Files:**\n- Test: `tests/workflow_runtime.rs`\n\n- [ ] **Step 1: Review the draft plan**\n",
    );
    write_plan_fidelity_review_artifact(
        repo,
        PlanFidelityReviewArtifactInput {
            artifact_rel: ".featureforge/reviews/plan-fidelity-design-review.md",
            plan_path,
            plan_revision: 1,
            spec_path,
            spec_revision: 1,
            review_verdict: "pass",
            reviewer_source: "fresh-context-subagent",
            reviewer_id: "reviewer-design-review",
            verified_surfaces: &["requirement_index", "execution_topology", "delivery_lane"],
        },
    );
    let receipt_json = run_workflow_plan_fidelity_json(
        repo,
        ...
        &[
            ...
            plan_path,
            "--review-artifact",
            ".featureforge/reviews/plan-fidelity-design-review.md",
            "--json",
        ],
        "workflow plan-fidelity record should succeed before design-review routing",
    );
    assert_eq!(receipt_json["status"], "ok");
    ...
    let status_json = parse_json(
        &run_rust_featureforge(
            ...
            state,
            &["workflow", "status", "--refresh"],
            "workflow status should route required design review before eng review",
        ),
        "workflow status should route required design review before eng review",
    );

    assert_eq!(status_json["status"], "plan_draft");
    assert_eq!(status_json["next_skill"], "featureforge:plan-design-review");
}

#[test]
fn canonical_workflow_status_routes_design_review_pass_back_to_plan_eng_review() {
    let (repo_dir, state_dir) = init_repo("workflow-runtime-plan-design-review-pass");
    let repo = repo_dir.path();
    let state = state_dir.path();
    let spec_path = "docs/featureforge/specs/2026-01-22-document-review-system-design.md";
    let plan_path = "docs/featureforge/plans/2026-01-22-document-review-system.md";
    ...
    write_file(
        &repo.join(plan_path),
        "# Draft Plan\n\n**Workflow State:** Draft\n**Plan Revision:** 1\n**Execution Mode:** none\n**Source Spec:** `docs/featureforge/specs/2026-01-22-document-review-system-design.md`\n**Source Spec Revision:** 1\n**Last Reviewed By:** writing-plans\n**Contract Version:** 2\n**Delivery Lane:** standard\n\n## Requirement Coverage Matrix\n\n- REQ-001 -> Task 1\n\n## Risk & Gate Signals\n- Delivery Lane: standard\n- UI Scope: material\n- Browser QA Required: no\n- Design Review Required: yes\n- Security Review Required: no\n- Performance Review Required: no\n- Release Surface: code_only_no_deploy\n- Distribution Impact: low\n- Deploy Impact: low\n- Migration Risk: low\n\n## Release & Distribution Notes\n- Discoverability / Distribution Path: internal only\n- Versioning Decision: unknown\n- Versioning Rationale: planning fixture\n- Deployment / Rollout Notes: none\n\n## Task 1: Prepare the draft plan for review\n\n**Spec Coverage:** REQ-001\n**Task Outcome:** The draft plan is ready for engineering review after design review.\n**Plan Constraints:**\n- Keep the fixture minimal.\n**Open Questions:** none\n\n**Files:**\n- Test: `tests/workflow_runtime.rs`\n\n- [ ] **Step 1: Review the draft plan**\n",
    );
    write_plan_fidelity_review_artifact(
        repo,
        PlanFidelityReviewArtifactInput {
            artifact_rel: ".featureforge/reviews/plan-fidelity-design-review-pass.md",
            plan_path,
            plan_revision: 1,
            spec_path,
            spec_revision: 1,
            review_verdict: "pass",
            reviewer_source: "fresh-context-subagent",
            reviewer_id: "reviewer-design-review-pass",
            verified_surfaces: &["requirement_index", "execution_topology", "delivery_lane"],
        },
    );
    let receipt_json = run_workflow_plan_fidelity_json(
        ...
        &[
            ...
            plan_path,
            "--review-artifact",
            ".featureforge/reviews/plan-fidelity-design-review-pass.md",
            "--json",
        ],
        "workflow plan-fidelity record should succeed before design-review pass routing",
    );
    assert_eq!(receipt_json["status"], "ok");
    let design_review_artifact = write_plan_design_review_artifact(state, repo, plan_path, "pass");
    let design_review_record = run_rust_featureforge(
        repo,
        state,
        &[
            "workflow",
            ...
            plan_path,
            "--review-artifact",
            &design_review_artifact.display().to_string(),
            "--json",
        ],
        "workflow plan-design-review record should succeed before pass routing",
    );
    assert!(
        design_review_record.status.success(),
        "plan-design-review record should succeed, got {:?}\nstdout:\n{}\nstderr:\n{}",
        design_review_record.status,
        String::from_utf8_lossy(&design_review_record.stdout),
        String::from_utf8_lossy(&design_review_record.stderr)
    );
    ...
    let status_json = parse_json(
        &run_rust_featureforge(
            ...
            state,
            &["workflow", "status", "--refresh"],
            "workflow status should route pass design review back to eng review",
        ),
        "workflow status should route pass design review back to eng review",
    );
...
#[test]
fn workflow_plan_design_review_record_uses_safe_branch_receipt_path() {
    let (repo_dir, state_dir) = init_repo("workflow-runtime-plan-design-review-safe-branch");
    let repo = repo_dir.path();
    let state = state_dir.path();
    let spec_path = "docs/featureforge/specs/2026-01-22-document-review-system-design.md";
    let plan_path = "docs/featureforge/plans/2026-01-22-document-review-system.md";
    ...
    write_plan_fidelity_review_artifact(
        repo,
        PlanFidelityReviewArtifactInput {
            artifact_rel: ".featureforge/reviews/plan-fidelity-design-review-safe-branch.md",
            plan_path,
            plan_revision: 1,
            spec_path,
            spec_revision: 1,
            review_verdict: "pass",
            reviewer_source: "fresh-context-subagent",
            reviewer_id: "reviewer-design-review-safe-branch",
            verified_surfaces: &["requirement_index", "execution_topology", "delivery_lane"],
        },
    );
    let receipt_json = run_workflow_plan_fidelity_json(
        ...
        &[
            ...
            plan_path,
            "--review-artifact",
            ".featureforge/reviews/plan-fidelity-design-review-safe-branch.md",
            "--json",
        ],
        "workflow plan-fidelity record should succeed before safe-branch design-review routing",
    );
    assert_eq!(receipt_json["status"], "ok");

    let design_review_artifact = write_plan_design_review_artifact(state, repo, plan_path, "pass");
    let design_review_record = parse_json(
        &run_rust_featureforge(
            repo,
            state,
            &[
            ...
            "workflow plan-design-review record should use a safe branch receipt path",
        ),
        "workflow plan-design-review record should use a safe branch receipt path",
    );

    let receipt_path = design_review_record["receipt_path"]
        .as_str()
        .expect("receipt path should be present");
    assert!(
        receipt_path.ends_with("-plan-design-review-receipt.md")
            && !receipt_path.contains("/dm/optimize-")
            && !receipt_path.contains("/dm/optimize/"),
        "receipt path should use a single safe branch filename instead of raw slash-separated branch components, got {receipt_path}"
    );
}

#[test]
fn canonical_workflow_status_uses_authoritative_design_review_copy_after_original_artifact_changes() {
    let (repo_dir, state_dir) = init_repo("workflow-runtime-plan-design-review-authoritative-copy");
    let repo = repo_dir.path();
    let state = state_dir.path();
    let spec_path = "docs/featureforge/specs/2026-01-22-document-review-system-design.md";
    let plan_path = "docs/featureforge/plans/2026-01-22-document-review-system.md";
    ...
    write_plan_fidelity_review_artifact(
        repo,
        PlanFidelityReviewArtifactInput {
            artifact_rel: ".featureforge/reviews/plan-fidelity-design-review-authoritative.md",
            plan_path,
            plan_revision: 1,
            spec_path,
            spec_revision: 1,
            review_verdict: "pass",
            reviewer_source: "fresh-context-subagent",
            reviewer_id: "reviewer-design-review-authoritative",
            verified_surfaces: &["requirement_index", "execution_topology", "delivery_lane"],
        },
    );
    let receipt_json = run_workflow_plan_fidelity_json(
        ...
        &[
            ...
            plan_path,
            "--review-artifact",
            ".featureforge/reviews/plan-fidelity-design-review-authoritative.md",
            "--json",
        ],
        "workflow plan-fidelity record should succeed before authoritative design-review routing",
    );
    assert_eq!(receipt_json["status"], "ok");
    let design_review_artifact = write_plan_design_review_artifact(state, repo, plan_path, "pass");
    let design_review_record = run_rust_featureforge(
        ...
        "workflow plan-design-review record should succeed before authoritative-copy routing",
    );
    assert!(design_review_record.status.success());

    write_file(
        &design_review_artifact,
        "# Plan Design Review Result\n**Source Plan:** `docs/featureforge/plans/2026-01-22-document-review-system.md`\n**Source Plan Revision:** 1\n**Branch:** fixture-work\n**Repo:** mutated\n**Receipt Fingerprint:** broken\n**Result:** revise\n**Generated By:** featureforge:plan-design-review\n**Generated At:** 2026-03-28T01:00:00Z\n",
    );
    ...
    let status_json = parse_json(
        &run_rust_featureforge(
            ...
            state,
            &["workflow", "status", "--refresh"],
            "workflow status should keep using authoritative design-review copy",
        ),
        "workflow status should keep using authoritative design-review copy",
    );
...
#[test]
fn canonical_workflow_status_rejects_stale_design_review_after_same_revision_plan_change() {
    let (repo_dir, state_dir) = init_repo("workflow-runtime-plan-design-review-stale-plan-fingerprint");
    let repo = repo_dir.path();
    let state = state_dir.path();
    let spec_path = "docs/featureforge/specs/2026-01-22-document-review-system-design.md";
    let plan_path = "docs/featureforge/plans/2026-01-22-document-review-system.md";
    ...
    write_file(
        &repo.join(plan_path),
        "# Approved Plan\n\n**Workflow State:** Engineering Approved\n**Plan Revision:** 1\n**Execution Mode:** none\n**Source Spec:** `docs/featureforge/specs/2026-01-22-document-review-system-design.md`\n**Source Spec Revision:** 1\n**Last Reviewed By:** plan-eng-review\n**Contract Version:** 2\n**Delivery Lane:** standard\n\n## Requirement Coverage Matrix\n\n- REQ-001 -> Task 1\n\n## Risk & Gate Signals\n- Delivery Lane: standard\n- UI Scope: material\n- Browser QA Required: no\n- Design Review Required: yes\n- Security Review Required: no\n- Performance Review Required: no\n- Release Surface: code_only_no_deploy\n- Distribution Impact: low\n- Deploy Impact: low\n- Migration Risk: low\n\n## Release & Distribution Notes\n- Discoverability / Distribution Path: internal only\n- Versioning Decision: unknown\n- Versioning Rationale: planning fixture\n- Deployment / Rollout Notes: none\n\n## Execution Strategy\n\n- Execute Task 1 last.\n\n## Dependency Diagram\n\n```text\nTask 1\n```\n\n## Task 1: Prepare the approved plan\n\n**Spec Coverage:** REQ-001\n**Task Outcome:** The approved plan is otherwise ready for implementation after design review.\n**Plan Constraints:**\n- Keep the fixture minimal.\n**Open Questions:** none\n\n**Files:**\n- Test: `tests/workflow_runtime.rs`\n\n- [ ] **Step 1: Review the approved plan**\n",
    );
    let design_review_artifact = write_plan_design_review_artifact(state, repo, plan_path, "pass");
    let design_review_record = run_rust_featureforge(
        repo,
        ...
        "workflow plan-design-review record should succeed before stale-plan-fingerprint routing",
    );
    assert!(design_review_record.status.success());
    ...
    replace_in_file(
        &repo.join(plan_path),
        "**Task Outcome:** The approved plan is otherwise ready for implementation after design review.\n",
        "**Task Outcome:** The approved plan is otherwise ready for implementation after design review, plus a newly documented warning state.\n",
    );
    ...
    let status_json = parse_json(
        &run_rust_featureforge(
            ...
            state,
            &["workflow", "status", "--refresh"],
            "workflow status should reject a stale design-review pass after a same-revision plan edit",
        ),
        "workflow status should reject a stale design-review pass after a same-revision plan edit",
    );
    ...
    assert!(
        status_json["reason_codes"]
            ...
            .expect("reason_codes should be an array")
            .iter()
            .any(|value| value == "plan_design_review_required"),
        "same-revision plan edits should invalidate the recorded design-review pass"
    );
}

#[test]
fn canonical_workflow_status_routes_eng_approved_plan_with_missing_design_review_back_to_plan_design_review() {
    let (repo_dir, state_dir) = init_repo("workflow-runtime-eng-approved-design-review-required");
    let repo = repo_dir.path();
    let state = state_dir.path();
    let spec_path = "docs/featureforge/specs/2026-01-22-document-review-system-design.md";
    let plan_path = "docs/featureforge/plans/2026-01-22-document-review-system.md";
    ...
    write_file(
        &repo.join(plan_path),
        "# Approved Plan\n\n**Workflow State:** Engineering Approved\n**Plan Revision:** 1\n**Execution Mode:** none\n**Source Spec:** `docs/featureforge/specs/2026-01-22-document-review-system-design.md`\n**Source Spec Revision:** 1\n**Last Reviewed By:** plan-eng-review\n**Contract Version:** 2\n**Delivery Lane:** standard\n\n## Requirement Coverage Matrix\n\n- REQ-001 -> Task 1\n\n## Risk & Gate Signals\n- Delivery Lane: standard\n- UI Scope: material\n- Browser QA Required: no\n- Design Review Required: yes\n- Security Review Required: no\n- Performance Review Required: no\n- Release Surface: code_only_no_deploy\n- Distribution Impact: low\n- Deploy Impact: low\n- Migration Risk: low\n\n## Release & Distribution Notes\n- Discoverability / Distribution Path: internal only\n- Versioning Decision: unknown\n- Versioning Rationale: approved fixture\n- Deployment / Rollout Notes: none\n\n## Execution Strategy\n\n- Execute Task 1 last.\n\n## Dependency Diagram\n\n```text\nTask 1\n```\n\n## Task 1: Prepare the approved plan\n\n**Spec Coverage:** REQ-001\n**Task Outcome:** The approved plan is otherwise ready for implementation.\n**Plan Constraints:**\n- Keep the fixture minimal.\n**Open Questions:** none\n\n**Files:**\n- Test: `tests/workflow_runtime.rs`\n\n- [ ] **Step 1: Review the approved plan**\n",
    );
    ...
    let status_json = parse_json(
        &run_rust_featureforge(
            ...
            state,
            &["workflow", "status", "--refresh"],
            "workflow status should reroute approved plans with missing design review",
        ),
        "workflow status should reroute approved plans with missing design review",
    );
...
#[test]
fn canonical_workflow_status_routes_design_review_revise_back_to_writing_plans() {
    let (repo_dir, state_dir) = init_repo("workflow-runtime-design-review-revise");
    let repo = repo_dir.path();
    let state = state_dir.path();
    let spec_path = "docs/featureforge/specs/2026-01-22-document-review-system-design.md";
    let plan_path = "docs/featureforge/plans/2026-01-22-document-review-system.md";
    ...
    write_plan_fidelity_review_artifact(
        repo,
        PlanFidelityReviewArtifactInput {
            artifact_rel: ".featureforge/reviews/plan-fidelity-design-review-revise.md",
            plan_path,
            plan_revision: 1,
            spec_path,
            spec_revision: 1,
            review_verdict: "pass",
            reviewer_source: "fresh-context-subagent",
            reviewer_id: "reviewer-design-review-revise",
            verified_surfaces: &["requirement_index", "execution_topology", "delivery_lane"],
        },
    );
    let receipt_json = run_workflow_plan_fidelity_json(
        ...
        &[
            ...
            plan_path,
            "--review-artifact",
            ".featureforge/reviews/plan-fidelity-design-review-revise.md",
            "--json",
        ],
        "workflow plan-fidelity record should succeed before revise design-review routing",
    );
    assert_eq!(receipt_json["status"], "ok");
    let design_review_artifact = write_plan_design_review_artifact(state, repo, plan_path, "revise");
    let design_review_record = run_rust_featureforge(
        repo,
        state,
        &[
        ...
        "workflow plan-design-review record should succeed before revise routing",
    );
    assert!(
        design_review_record.status.success(),
        "plan-design-review record should succeed, got {:?}\nstdout:\n{}\nstderr:\n{}",
    ...
    let status_json = parse_json(
        &run_rust_featureforge(
            ...
            state,
            &["workflow", "status", "--refresh"],
            "workflow status should route revise design review back to writing-plans",
        ),
        "workflow status should route revise design review back to writing-plans",
    );
...
#[test]
fn canonical_workflow_status_routes_disqualified_lightweight_plans_back_to_writing_plans() {
    let (repo_dir, state_dir) = init_repo("workflow-runtime-lightweight-escalation");
    let repo = repo_dir.path();
    let state = state_dir.path();
    let spec_path = "docs/featureforge/specs/2026-01-22-document-review-system-design.md";
    let plan_path = "docs/featureforge/plans/2026-01-22-document-review-system.md";
    ...
    let status_json = parse_json(
        &run_rust_featureforge(
            ...
            state,
            &["workflow", "status", "--refresh"],
            "workflow status should route disqualified lightweight plans back to writing-plans",
        ),
        "workflow status should route disqualified lightweight plans back to writing-plans",
    );
    ...
    assert!(
        status_json["reason_codes"]
            ...
            .expect("reason_codes should be an array")
            .iter()
            .any(|value| value == "lightweight_lane_escalated"),
        "disqualified lightweight plans should expose explicit escalation routing"
    );
}

#[test]
fn workflow_plan_fidelity_record_rejects_disqualified_lightweight_drafts() {
    let (repo_dir, state_dir) = init_repo("workflow-runtime-plan-fidelity-lightweight-disqualified");
    let repo = repo_dir.path();
    let state = state_dir.path();
    let spec_path = "docs/featureforge/specs/2026-01-22-document-review-system-design.md";
    let plan_path = "docs/featureforge/plans/2026-01-22-document-review-system.md";
    ...
    let output = run_rust_featureforge(
        ...
        "workflow plan-fidelity record should reject disqualified lightweight drafts",
    );
    assert!(
        !output.status.success(),
        "record should fail closed for disqualified lightweight drafts, got {:?}\nstdout:\n{}\nstderr:\n{}",
        output.status,
...
#[test]
fn workflow_plan_fidelity_record_rejects_current_version_drafts_missing_risk_gate_sections() {
    let (repo_dir, state_dir) = init_repo("workflow-runtime-plan-fidelity-missing-risk-gates");
    let repo = repo_dir.path();
    let state = state_dir.path();
    let spec_path = "docs/featureforge/specs/2026-01-22-document-review-system-design.md";
    let plan_path = "docs/featureforge/plans/2026-01-22-document-review-system.md";
    ...
    write_plan_fidelity_review_artifact(
        repo,
        PlanFidelityReviewArtifactInput {
            artifact_rel: ".featureforge/reviews/plan-fidelity-missing-risk-gates.md",
            plan_path,
            plan_revision: 1,
            spec_path,
            spec_revision: 1,
            review_verdict: "pass",
            reviewer_source: "fresh-context-subagent",
            reviewer_id: "reviewer-missing-risk-gates",
            verified_surfaces: &["requirement_index", "execution_topology", "delivery_lane"],
        },
    );
    ...
    let output = run_rust_featureforge(
        ...
        &[
            ...
            plan_path,
            "--review-artifact",
            ".featureforge/reviews/plan-fidelity-missing-risk-gates.md",
            "--json",
        ],
        "workflow plan-fidelity record should reject v2 drafts missing risk-gate sections",
    );
    assert!(
        !output.status.success(),
        "record should fail closed for v2 drafts missing risk-gate sections, got {:?}\nstdout:\n{}\nstderr:\n{}",
        output.status,
        String::from_utf8_lossy(&output.stdout),
        String::from_utf8_lossy(&output.stderr)
    );
