...
require_pattern skills/plan-eng-review/SKILL.md '**Source Plan:** `docs/superpowers/plans/...`'
require_pattern skills/plan-eng-review/SKILL.md '**Source Plan Revision:** 3'
require_pattern skills/plan-eng-review/SKILL.md '**Browser QA Required:** yes'
require_pattern skills/plan-eng-review/SKILL.md '**Generated By:** superpowers:plan-eng-review'
...
require_pattern skills/qa-only/SKILL.md '**Head SHA:** abc1234'
require_pattern skills/qa-only/SKILL.md '**Result:** pass'
require_pattern skills/qa-only/SKILL.md '**Generated By:** superpowers:qa-only'
...
require_pattern skills/document-release/SKILL.md '**Base Branch:** main'
require_pattern skills/document-release/SKILL.md '**Head SHA:** abc1234'
require_pattern skills/document-release/SKILL.md '**Result:** pass'
require_pattern skills/document-release/SKILL.md '**Generated By:** superpowers:document-release'
...
require_pattern skills/finishing-a-development-branch/SKILL.md 'If the finish gate returns `allowed` `false`, stop and return to the current execution flow; do not present completion options against stale QA or release artifacts.'
