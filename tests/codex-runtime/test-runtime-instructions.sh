...
required_patterns=(
  ...
  "superpowers-upgrade/SKILL.md:bin/superpowers-config.ps1"
  "superpowers-upgrade/SKILL.md:bin/superpowers-install-runtime.ps1"
  "superpowers-upgrade/SKILL.md:The shell snippets below use the bash entrypoints."
