...
When a test-plan artifact includes richer additive sections such as `## Coverage Graph`, `## Browser Matrix`, `## Non-Browser Contract Checks`, `## Regression Risks`, `## Manual QA Notes`, or `## Engineering Review Summary`, treat them as additive context only:
