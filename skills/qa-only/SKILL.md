...
if [ -z "$BASE_BRANCH" ]; then
  echo "Missing BASE_BRANCH. For workflow-routed QA, use the runtime-owned release-lineage base branch; otherwise set BASE_BRANCH explicitly before continuing."
  exit 1
fi
