...
7. **Write design doc** — save to `docs/featureforge/specs/YYYY-MM-DD-<topic>-design.md` and commit
8. **Automatic spec review handoff** — invoke `featureforge:plan-ceo-review` after writing the spec
...
1. Invoke `featureforge:plan-ceo-review` after writing the spec
