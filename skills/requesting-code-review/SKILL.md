...
- runs `record-review-dispatch --plan ...` as the helper-owned fail-closed provenance gate before terminal final review dispatch, while preserving task-boundary command semantics
