...
- 2026-03-29: `plan-eng-review` write-target drift was identified during the project-memory rollout.
  ...
  Source: `docs/archive/featureforge/execution-evidence/2026-03-30-featureforge-session-entry-removal-r1-evidence.md`, `skills/plan-eng-review/SKILL.md`
...
- 2026-03-29: Task-boundary review closure was promoted from rollout follow-up into shipped runtime behavior.
  ...
  Source: `docs/archive/featureforge/execution-evidence/2026-03-30-featureforge-session-entry-removal-r1-evidence.md`, `README.md`
